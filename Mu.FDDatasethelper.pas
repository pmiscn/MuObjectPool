...
function TFDDatasetHelper.FieldDefByName(aFieldName: String): TFieldDef;
begin
  result := Self.FieldDefs.Find(aFieldName);
end;

procedure TFDDatasetHelper.FieldsFromRecord<T>(aRecord: T);
var
  AType: PTypeInfo;
  AValue: TValue;
var
...
procedure TFDDatasetHelper.FieldsFromRecordType<T>();
var
  AType: PTypeInfo;
  AValue: TValue;
var
...
function TFDDatasetHelper.FromRecord<T>(aRecord: T): boolean;
var
  AType: PTypeInfo;
  AValue: TValue;
var
...
function TFDDatasetHelper.AppendFromQJson(rjs: TQjson): boolean;
var
  fd: TField;
  I: Integer;
...
function TFDDatasetHelper.AppendRecord<T>(aRecord: T): boolean;
var
  AType: PTypeInfo;
  AValue: TValue;
var
...
function TFDDatasetHelper.ToRecord<T>(var aRecord: T): boolean;
var
  AType: PTypeInfo;
  AValue: TValue;
var
...
function TFDDatasetHelper.Update(aException, aWhere: String): TQDataSet;
begin
  result := Self.Where(aWhere).Update(aException);
end;

function TFDDatasetHelper.Update(aException: String): TQDataSet;
var
...
function TFDDatasetHelper.Where(aDesc: TQDataSet; aWhere: String): TQDataSet;
begin
  result := aDesc;
  with aDesc do
  begin
...
function TFDDatasetHelper.Where(aWhere: String; aIsClone: boolean = false)
  : TQDataSet;
begin
  if aIsClone then
  begin
