...
begin
  ...
  else if (Assigned(FOnPromptKeyPress)) then
  ...
  case ord(AKey) of
    ...
    Begin
      if (CaretX > Length(CurrLine.Text)) then
        CurrLine.Text := CurrLine.Text + AKey
      else if InsertMode then
        Insert(AKey, CurrLine.Text, CaretX) // Insert Mode
      else
