  ...
  TLocalFileInfo = record
    ...
    public
      class function create(aFileName: string; AProgress: TOnProgress = nil; AFileProgress: TOnProgress = nil;
        AStatus: TOnStatus = nil): TLocalFileInfo; static;
      ...
      class function GetFileVersion(aFileName: string = ''): String; static;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        // AStatus(st[I]);
        result.Files[I] := TLocalFileInfo.create(st[I], AProgress, AFileProgress, AStatus);
      end;
    finally
      st.Free;
    end;
...
class function TLocalFileInfo.GetFileVersion(aFileName: string): String;
begin
  result := TLocalFileInfo.GetFileVersionNumber(aFileName);
end;
...
var
  d: TQMD5Digest;
begin
  d := qdigest.MD5Hash(astream,
    procedure(AHashed, ATotal: int64)
    var
      C: boolean;
    begin
      C := false;
      ...
      begin
        AProgress(ATotal, AHashed, C);
      end;
    end);
  result := DigestToString(d);
end;
